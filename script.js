...
const programas = [
    ...
    {
        programa: "Comunicación Digital Esp. Diseño y Desarrollo de Videojuegos",
        universidad: "UNIACC",
        region: "Metropolitana",
        tipo: "Privada",
        arancel: 4580000,
    ...
    {
        programa: "Diseño en Animación Digital",
        universidad: "Universidad Gabriela Mistral",
        region: "Metropolitana",
        tipo: "Privada",
        arancel: 4814000,
    ...
    {
        programa: "Diseño en Comunicación Visual",
    ...
    {
        programa: "Diseño en Interacción Digital",
        universidad: "Universidad Gabriela Mistral",
        region: "Metropolitana",
        tipo: "Privada",
        arancel: 4814000,
    ...
    {
        programa: "Diseño Gráfico Especialidad Multimedia",
        universidad: "UNIACC",
        region: "Metropolitana",
        tipo: "Privada",
        arancel: 4210000,
    ...
    {
        programa: "Diseño Gráfico Mención Diseño Estratégico",
        universidad: "Universidad de Antofagasta",
        region: "Antofagasta",
        tipo: "Estatal",
        arancel: 5120000,
        acreditacion: 5,
    ...
    {
        programa: "Diseño Mención Industrial/Gráfico/Ambientes",
    ...
    {
        programa: "Ingeniería en Diseño de Productos",
        universidad: "Univ. Técnica Federico Santa María",
        region: "Metropolitana",
        tipo: "Privada",
        arancel: 6000000,
        acreditacion: 6,
    ...
    {
        programa: "Ingeniería en Fabricación y Diseño Industrial",
        universidad: "Univ. Técnica Federico Santa María",
        region: "Valparaíso",
        tipo: "Privada",
        arancel: 5180000,
    ...
    {
        programa: "Ingeniería en Realidad Virtual y Diseño de Juegos Digitales",
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const regionesOrdenadas = Object.entries(vacantasPorRegion).sort((a, b) => b[1] - a[1]);
            ...
            datasets: [
                {
                    ...
                    backgroundColor: regionesOrdenadas.map((r) =>
                        r[0] === "Metropolitana" ? "rgba(232, 87, 26, 0.85)" : "rgba(232, 87, 26, 0.35)"
                    ),
                    borderColor: regionesOrdenadas.map((r) =>
                        r[0] === "Metropolitana" ? "rgba(232, 87, 26, 1)" : "rgba(232, 87, 26, 0.6)"
                    ),
                    borderWidth: 1,
                    borderRadius: 2,
                },
    ...
    function renderTabla(datos) {
        ...
        contador.textContent =
            total === programas.length ? `${total} programas` : `${total} de ${programas.length} programas`;
    }
